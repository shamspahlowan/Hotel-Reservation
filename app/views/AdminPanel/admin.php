    ...
    <main class="main-content">
      ...
      <section class="content-section active" id="dashboard-section">
        ...
        <div class="card-grid">
          ...
          <div class="card stat-card">
            ...
            <div class="stat-value">$184,389</div>
            <div class="stat-change">
      ...
      <section class="content-section user-role-section" id="hotels-section">
        ...
        <div class="card" style="margin-top: 24px">
          <div class="table-header">
            <h2 class="table-title">Room Types</h2>
            <button class="btn btn-outline">Add Room Type</button>
          </div>
          <table class="table">
            <thead>
              <tr>
      ...
      <section class="content-section user-role-section" id="bookings-section">
        ...
        <div class="card-grid">
          ...
          <div class="card stat-card">
            ...
            <div class="stat-value">1,985</div>
            <div class="stat-change">72% of total</div>
          </div>
          <div class="card stat-card">
            <div class="stat-title">Pending</div>
            <div class="stat-value">642</div>
            <div class="stat-change">23% of total</div>
          </div>
          <div class="card stat-card">
            <div class="stat-title">Canceled</div>
            <div class="stat-value">131</div>
            <div class="stat-change">5% of total</div>
          </div>
        </div>
        <!-- Bookings Table -->
        <div class="table-container">
      ...
      <section class="content-section user-role-section" id="transactions-section">
        ...
        <div class="card-grid">
          ...
          <div class="card stat-card">
            ...
            <div class="stat-value">$42,765</div>
            <div class="stat-change">
              <span>[Up]</span>
            ...
            <div class="chart-container" style="height: 200px; display: flex; align-items: center; justify-content: center;">
              <div style="text-align: center; width: 100%">
                ...
                <div style="width: 100%; height: 10px; background-color: #eee; border-radius: 5px; margin-bottom: 15px;">
                  <div style="width: 75%; height: 10px; background-color: var(--brand-color); border-radius: 5px;"></div>
                </div>
                <div style="display: flex; justify-content: space-between; margin-bottom: 10px;">
                ...
                <div style="width: 100%; height: 10px; background-color: #eee; border-radius: 5px; margin-bottom: 15px;">
                  <div style="width: 15%; height: 10px; background-color: var(--brand-color); border-radius: 5px;"></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <!-- Placeholder Sections for Profile and Settings -->
