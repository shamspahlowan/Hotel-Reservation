// search.js
const rooms = [
  { name: "Ocean View", location: "Cox's Bazar", price: 90, type: "Double", amenities: ["Wi-Fi", "AC"] },
  { name: "Mountain Retreat", location: "Bandarban", price: 150, type: "Suite", amenities: ["Wi-Fi"] },
  { name: "City Stay", location: "Dhaka", price: 80, type: "Single", amenities: ["AC"] },
  { name: "Luxury Palace", location: "Sylhet", price: 220, type: "Suite", amenities: ["Wi-Fi", "AC"] },
];
...
function filterRooms() {
  ...
  let filtered = rooms.filter(room => {
    const matchesKeyword = room.name.toLowerCase().includes(keyword) || room.location.toLowerCase().includes(keyword);
